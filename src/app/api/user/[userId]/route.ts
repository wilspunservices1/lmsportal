...
export async function GET(
	...
	try {
		...
		const enrolledCoursesProcessed: Course[] =
			includeEnrolledCourses && fetchedUser.enrolledCourses
				? Array.isArray(fetchedUser.enrolledCourses)
					? fetchedUser.enrolledCourses
					: JSON.parse(fetchedUser.enrolledCourses) // ✅ Convert string to JSON
				: [];
