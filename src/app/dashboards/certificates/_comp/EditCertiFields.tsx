...
//           body: JSON.stringify({ placeholderId, x, y }),
//         });
//         if (!response.ok) console.error("Failed to update placeholder in DB");
//       } catch (err) {
//         console.error("Error updating placeholder in DB:", err);
//       }
//     },
...
//   useEffect(() => {
//     return () => debouncedUpdatePlaceholderCoordinates.cancel();
//   }, [debouncedUpdatePlaceholderCoordinates]);
...
//                         togglePlaceholderVisibility(ph.id, newVisibility);
//                       }
//                       return { ...ph, is_visible: newVisibility };
//                     })
//                   );
//                 }}
//                 className="mb-4"
...
//                           prev.map(item => 
//                             item.id === ph.id ? {...item, font_family: e.target.value} : item
//                           )
//                         )}
...
//                           setSelectedPlaceholders(prev =>
//                             prev.map(item => 
//                               item.id === ph.id ? {...item, font_size: size} : item
//                             )
//                           );
//                         }}
//                         className="w-16 px-2 py-1 border rounded"
...
//                         onChange={(e) => setSelectedPlaceholders(prev => 
//                           prev.map(item => 
//                             item.id === ph.id ? {...item, color: e.target.value} : item
//                           )
//                         )}
//                         className="w-8 h-8"
//                       />
...
//                   <Draggable
//                     key={placeholder.id}
//                     defaultPosition={{ x: placeholder.x || 0, y: placeholder.y || 0 }}
//                     bounds="parent"
//                     onStop={(e, data) => {
//                       setSelectedPlaceholders((prev) =>
//                         prev.map((item) =>
