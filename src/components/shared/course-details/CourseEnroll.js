    ...
    >
      ...
      <div className="mb-5" data-aos="fade-up">
        ...
        <Link
          ...
          className="text-size-13 text-contentColor dark:text-contentColor-dark leading-1.8 hover:text-secondaryColor dark:hover:text-secondaryColor transition-colors"
        >
          <i className="icofont-ui-rotation"></i> Refund Policy: 100% refund if
          requested within 30 days of enrollment.
        </Link>
      </div>
