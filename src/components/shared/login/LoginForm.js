          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 rounded-md py-3 px-4 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-yellow"
              >
