	...
	return (
		<div className="lg:col-start-9 lg:col-span-4" data-aos="fade-up">
			<div className="p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg">
				<h3 className="text-xl font-semibold text-blue-600 mb-4">Course Setup</h3>
						...
						<div className="mb-6">
							...
							<ul>
								{filePaths.map((filePath, index) => (
									<li
										key={index}
										className="text-sm text-gray-600 dark:text-gray-400 mb-2 flex items-center justify-between"
									>
										<div>
